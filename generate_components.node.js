...
const authModal = `import { useState } from "react";
...
const checkoutModal = `import { useState } from "react";
...
const navbar = `import { Link } from "react-router-dom";
...
const cartPage = `import { Trash2, ShoppingBag, ArrowRight } from "lucide-react";
...
const appPage = `import { useState, useEffect } from "react";
...
fs.writeFileSync("d:/Pet Shop/frontend/src/components/AuthModal.jsx", authModal);
fs.writeFileSync("d:/Pet Shop/frontend/src/components/CheckoutModal.jsx", checkoutModal);
fs.writeFileSync("d:/Pet Shop/frontend/src/components/Navbar.jsx", navbar);
fs.writeFileSync("d:/Pet Shop/frontend/src/pages/CartPage.jsx", cartPage);
fs.writeFileSync("d:/Pet Shop/frontend/src/App.jsx", appPage);
